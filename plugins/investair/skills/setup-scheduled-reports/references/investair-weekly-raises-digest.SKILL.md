...
- A short table from `ranked`: Ticker, Company, Proceeds (A$M from `proceeds` — confirmed only), Discount (if available), DAP (if available). Do not cite proposed proceeds or issue price
